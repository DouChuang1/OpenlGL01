...
int main()
{
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		glUniform3f(lightPosLoc, 10.0f, 10.0f, 5.0f); // 光位置 
		glUniform3f(lightCorLoc, 1.0f, 1.0f, 1.0f); // 光位置 
		glUniform3f(cameraPosLoc, camera.Position.x, camera.Position.y, camera.Position.z); // 光位置 
